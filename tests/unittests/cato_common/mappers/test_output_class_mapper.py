...
def test_from_dict_with_id(object_mapper):
    result = object_mapper.from_dict(
        {"id": 1, "testResultId": 2, "text": "my text"}, Output
    )
...
def test_from_dict_without_id(object_mapper):
    result = object_mapper.from_dict({"testResultId": 2, "text": "my text"}, Output)
...
def test_to_dict(object_mapper):
    ...
    assert result == {"id": 1, "testResultId": 2, "text": "my text"}
