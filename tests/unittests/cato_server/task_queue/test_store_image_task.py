...
def test_should_call_store_image_successfully(test_context, stored_image_factory):
    original_file = stored_image_factory()
    test_context.mock_file_storage.find_by_id.return_value = original_file

    test_context.store_image_task._execute(
