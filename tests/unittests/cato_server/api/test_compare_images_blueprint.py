...
def test_upload_images_async_for_comparison_success(
    client_with_session, test_resource_provider, object_mapper
):
    test_image = test_resource_provider.resource_by_name("test_image_white.jpg")
    data = {
...
def test_upload_images_async_should_fail_no_parsable_comparison_settings(
    client_with_session, test_resource_provider, object_mapper
):
    test_image = test_resource_provider.resource_by_name("test_image_white.jpg")
    data = {
...
def test_upload_images_async_should_fail_no_reference_image(
    client_with_session, test_resource_provider, object_mapper
):
    test_image = test_resource_provider.resource_by_name("test_image_white.jpg")
    data = {
...
def test_upload_async_should_fail_with_non_image_data(
    client_with_session, test_resource_provider, object_mapper
):
    test_image = test_resource_provider.resource_by_name("unsupported-file.txt")
    data = {
