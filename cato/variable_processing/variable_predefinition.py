...
VRAY_FOR_MAYA_PREDEFINITION = VariablePredefinition(
    ...
    variables={
        ...
        "vray_render_command": r'"{@maya_location}\vray\bin\vray.exe" -sceneFile={@vray_scene_file} -imgFile={@image_output_exr}',
    },
)
...
MTOA_PREDEFINITION = VariablePredefinition(
    ...
    variables={
        ...
        "arnold_location": "C:\Program Files\Autodesk\Arnold\{@maya_version}",
