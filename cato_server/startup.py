...
from cato_server.api.middlewares.db_session_middleware import DbSessionMiddleware
...
def create_app(
    ...
    app.middleware("http")(obj_graph.provide(DbSessionMiddleware))
...
def setup_app_for_production(app, config):
